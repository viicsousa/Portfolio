...
export default function Contact() {
  return (
    <Container id="contacts">
      ...
      <Contacts>
        <Contato>
          <a href="mailto:victoria.vasconcelos@hotmail.com" target="_blank">
        ...
        <Contato>
          <a
            href="https://www.linkedin.com/in/vict%C3%B3ria-vasconcelos-de-sousa-aguiar-28550392/"
            target="_blank"
          >
